...
* Cinq profils prêts à l'emploi de complexité croissante : `random`, `greedy`, `rule_based`, `mcts` (simulation Monte-Carlo par rollouts), `human` (console interactive).
